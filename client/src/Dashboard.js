        ...
        const fetchStats = async () => {
            ...
            try {
                ...
                const typefaceResponse = await fetch(
                    `${apiUrl("/api/stats/typeface")}${muniParam}`
                );
                ...
                const letteringResponse = await fetch(
                    `${apiUrl("/api/stats/lettering-ontology")}${muniParam}`
                );
                ...
                const messageFunctionResponse = await fetch(
                    `${apiUrl("/api/stats/message-function")}${muniParam}`
                );
                ...
                const placementResponse = await fetch(
                    `${apiUrl("/api/stats/placement")}${muniParam}`
                );
                ...
                const covidResponse = await fetch(
                    `${apiUrl("/api/stats/covid")}${muniParam}`
                );
                if (!covidResponse.ok) {
                    throw new Error(
                ...
                {view === "municipality" ? (
                    <>
                        ...
                        <Flex direction="row" gap={4} mb={4}>
                            <StatisticsChart
                                title="Typeface Distribution"
                                data={typefaceData}
                                dataKey="typeface"
                                barLabel="Number of Occurrences"
                                badgeColorScheme="purple"
                            />
                            <StatisticsChart
                                title="Lettering Classifications"
                                data={letteringData}
                                dataKey="ontology"
                                barLabel="Number of Typefaces"
